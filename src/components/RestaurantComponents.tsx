...
export const RestaurantHero = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
      {/* ... (BEZ ZMIAN W HERO, ZACHOWAJ STARY KOD) ... */}
      {/* Skopiuj po prostu starą wersję Hero stąd, bo nic nie zmieniamy w Hero */}
      <div className="lg:col-span-2 bg-[#1A1A1A] rounded-2xl p-6 border border-[#2A2A2A] relative overflow-hidden shadow-2xl flex flex-col md:flex-row gap-6">
        <div className="w-full md:w-48 h-48 rounded-xl overflow-hidden flex-shrink-0 relative border border-[#333]">
           <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=400" alt="Pizza Hut" className="w-full h-full object-cover"/>
        </div>
        <div className="flex-1 flex flex-col justify-between">
            <div>
                <div className="flex items-center gap-3 mb-2">
                    <h1 className="text-4xl font-extrabold text-white tracking-tight">Pizza Hut</h1>
                    <span className="px-3 py-1 bg-green-500/20 text-green-400 text-xs font-bold uppercase tracking-wider rounded-full border border-green-500/30">● Otwarte teraz</span>
                </div>
                <p className="text-gray-400 flex items-center gap-2 mb-4 text-sm">
                    ...
                    <a href={mapLink} target="_blank" rel="noreferrer" className="text-[#FF6B6B] font-bold cursor-pointer hover:underline ml-2">Zobacz na mapie</a>
                </p>
                <p className="text-gray-500 text-sm leading-relaxed mb-6">Najpopularniejsza sieć pizzerii na świecie.</p>
            </div>
            <div className="flex flex-wrap gap-3">
                <div className="bg-[#252525] px-4 py-2 rounded-lg flex items-center gap-3 border border-[#333] flex-1 min-w-[140px]">
                    ...
                    <div><p className="text-[10px] text-gray-500 font-bold uppercase">Dostawa</p><p className="text-white font-bold text-sm">6.99 zł</p></div>
                </div>
                <div className="bg-[#252525] px-4 py-2 rounded-lg flex items-center gap-3 border border-[#333] flex-1 min-w-[140px]">
                    <ShoppingBasket className="text-[#FF6B6B]" size={20} />
                    <div><p className="text-[10px] text-gray-500 font-bold uppercase">Min.</p><p className="text-white font-bold text-sm">35.00 zł</p></div>
                </div>
                <div className="bg-[#252525] px-4 py-2 rounded-lg flex items-center gap-3 border border-[#333] flex-grow-[2] min-w-[200px]">
                    ...
                    <div><p className="text-[10px] text-gray-500 font-bold uppercase">Czas</p><p className="text-white font-bold text-sm">30-40 min</p></div>
                </div>
            </div>
        </div>
      </div>
      <div className="hidden lg:flex flex-col justify-center bg-[#1A1A1A] rounded-2xl p-6 border border-[#2A2A2A] shadow-xl h-full">
         <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2"><Clock className="text-[#FF6B6B]" size={20} /> Godziny otwarcia</h3>
         <ul className="space-y-3 text-sm text-gray-400">
            ...
            <li className="flex justify-between text-white font-bold bg-white/5 px-2 -mx-2 py-1 rounded"><span>Piątek</span><span>11:00 - 23:00</span></li>
  ...
  return (
    <div className="bg-[#1A1A1A] rounded-xl overflow-hidden border border-[#2A2A2A] hover:border-[#333] transition-all duration-300 flex group min-h-[144px] relative shadow-lg">
      <div className="w-36 h-auto flex-shrink-0 overflow-hidden relative">
        ...
        {/* ZMIANA: Badge NOWA na zdjęciu w Menu */}
        {isNew && (
            <span className="absolute top-2 left-2 bg-yellow-500 text-black text-[10px] font-bold px-2 py-0.5 rounded shadow-md">
                NOWA
            </span>
        )}
      </div>
...
// --- 3. RIGHT SIDEBAR (BEZ ZMIAN) ---
export const RightSidebar = () => {
    // ... skopiuj kod z poprzedniej wersji lub zostaw jak jest, bo tu nie ma zmian
    const mapLink = "https://www.google.com/maps?q=52.20064825424179,20.931893529706343";
    return (
        <div className="space-y-6 sticky top-6">
            <div className="bg-[#1A1A1A] rounded-2xl p-6 border border-[#2A2A2A] shadow-xl">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-white flex items-center gap-2"><Star className="text-[#FF6B6B] fill-[#FF6B6B]" size={18} /> Opinie</h3>
                ...
                <div className="flex items-end gap-4 mb-6">
                    ...
                    <div className="mb-1">
                        <div className="flex text-[#FF6B6B] mb-1">
                            <Star size={16} fill="currentColor" /><Star size={16} fill="currentColor" /><Star size={16} fill="currentColor" /><Star size={16} fill="currentColor" /><Star size={16} fill="currentColor" className="opacity-50" />
                        </div>
                ...
                <div className="bg-[#252525] p-4 rounded-xl border border-[#333] relative">
                    ...
                    <div className="flex items-center gap-3 mb-3 relative z-10">
                        <div className="w-10 h-10 bg-[#FF6B6B] text-white font-bold text-xs flex items-center justify-center rounded-full shadow-lg shadow-red-500/20 ring-2 ring-[#1A1A1A]">WW</div>
                        <div><p className="font-bold text-white text-sm">Wiktor W.</p><p className="text-[10px] text-gray-500 uppercase tracking-wide">2 dni temu</p></div>
                    </div>
                    <p className="text-gray-300 text-sm italic leading-relaxed pl-13">"Antonio jak ci sie podoba?"</p>
                </div>
            </div>
            <div className="bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] overflow-hidden h-56 relative shadow-xl z-0">
                <MapComponent coords={[52.20064825424179, 20.931893529706343]} popupText="Pizza Hut - Al. Jerozolimskie 54" />
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-[400]">
                    <a href={mapLink} target="_blank" rel="noreferrer" className="bg-[#1A1A1A] text-white px-4 py-2 rounded-full flex items-center gap-2 font-bold text-xs shadow-xl border border-[#333] hover:bg-[#FF6B6B] hover:border-[#FF6B6B] transition-all"><MapPin size={14} /> Nawiguj</a>
                </div>
            </div>
        </div>
    );
