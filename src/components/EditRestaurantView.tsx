              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    type="text"
                    className="w-full bg-[#1A1A1A] border border-[#333] rounded-lg p-3 text-white focus:border-yellow-500 text-xs text-gray-400"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full py-4 rounded-lg bg-yellow-500 hover:bg-yellow-600 text-black font-bold shadow-lg shadow-yellow-500/20 transition text-lg"
              >
                Zapisz zmiany
              </button>
            </div>
